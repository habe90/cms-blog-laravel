    ...
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('blog_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/posts*")||request()->is("admin/categories*")||request()->is("admin/tags*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fab fa-blogger">
                            </i>
                ...
                @can('administration_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/cache-managements*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-cogs">
                            </i>
                            {{ trans('cruds.administration.title') }}
                        </a>
                        <ul class="ml-4 subnav hidden">
                            @can('cache_management_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/cache-managements*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.cache-managements.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-eraser">
                                        </i>
                                        {{ trans('cruds.cacheManagement.title') }}
                                    </a>
                                </li>
                            @endcan
                        </ul>
